...
ob_cond$inflevel3 <- factor(ob_cond$inflevel3)
...
# keep <- ob_cond$Treatment!="enz"
# write.csv(dat[,keep], file = "out/out.counts/all_counts_sf.csv")
# write.csv(ob_cond[keep,], file = "out/out.counts/all_cond.csv")
...
# keep <- ob_cond$Treatment!="enz" & ob_cond$Series=="tube"
# write.csv(dat[,keep], file = "out/out.counts/justtube_data_counts_sf.csv")
# write.csv(ob_cond[keep,], file = "out/out.counts/justube_data_cond.csv")
